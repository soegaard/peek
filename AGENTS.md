...
19. In Markdown `--pretty` mode, it is acceptable to drop low-value wrapper punctuation such as backticks or link/image/autolink wrappers when the meaningful text and styling are preserved.
